...
:::{#isopod}
## Bugs are pretty fun. Here are a few of mine:

![Cubaris Murina](Media/Hobbies/isopods.cubaris.murina.papaya.png){width="50%" style="border-radius: 70%;"}
:::
...
--------------------------------------------------------------------------------
- **Data Analysis:** Experienced in Python, R, and SQL, with a knack for uncovering meaningful patterns and trends in data.
...
- **Communication:** Excellent communicator with a knack for distilling complex ideas into clear, concise messages.
